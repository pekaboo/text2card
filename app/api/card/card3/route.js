...
export async function GET(req) {
  ...
  // 发送 GET 请求
  await axios.get('https://moyu-server.wangyitu.tech/api/proxy?url=https://tenapi.cn/v2/comment?t='+new Date().getTime())
  ...
  .catch(error => {
    renderData =  {
      ...
      sings: 'Cheng橙zzzz',
      album: '你走（完整版）',
      cover: 'https://p2.music.126.net/nNg4YjkcK1AwCX1FrN8VOQ==/109951166578333625.jpg',
      url: 'https://music.163.com/song/media/outer/url?id=1460656959.mp3',
      name: 'Cheng橙zzzz',
      comment: '我给她梳过头发，洗过澡，穿过衣服做过饭，亲她掉下来的眼泪，吃她剩下来的东西，她邹下眉头我都会紧张，我们吵过架，但是我都会放下所有的情绪去哄她，冬天冷了我会握住她的手，生病了我会喂她吃药，哄她睡觉，什么时候都是让着她，我很清楚一个女孩爱的样子。所以我依然很清楚的记得她背叛我的样子'
    }
  });
  if(!renderData){
  ...
  ctx.fillText("在「"+renderData['album']+"」", canvas.width - 10, textY + 120);
